...
`);
    ...
    async function init() {
        ...
        gtag('event', data.showOnlyStarredProjects ? 'projects-load-starred' : 'projects-load-all', {
            'event_category' : 'projects',
            'event_label' : data.showOnlyStarredProjects ? 'Loading only starred projects' : 'Loading all projects',
    ...
    function projectStarsToggleClicked(event) {
        ...
        gtag('event', data.showOnlyStarredProjects ? 'projects-toggle-starred' : 'projects-toggle-all', {
            'event_category' : 'projects',
            'event_label' : data.showOnlyStarredProjects ? 'Show starred projects' : 'Show all projects'
        });
    }
