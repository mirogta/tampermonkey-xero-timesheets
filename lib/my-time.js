...
#_token_note::after {
    content: "Please wait a moment to load…";
    position: absolute;
    top: 50%;
    left: 50%;
    font-size: 50px;
    ...
    async function secureFetch(url, method, body, responseFn) {
     ...
     async function waitForAuthentication() {
         ...
         if(token === null) {
             ...
             setTimeout(waitForAuthentication, 1000);
             const el = document.getElementById('_token_note');
             if(el) {
