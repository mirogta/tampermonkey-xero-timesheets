...
`);
    ...
    function addHelpMenu() {
        ...
        issueButton.addEventListener('click', issueButtonClicked, false);
    ...
    function showIntro() {
        ...
        gtag('event', 'mytime-help-restart-walkthrough', {
            'event_category' : 'mytime',
            'event_label' : 'Timesheet Help - Restart Walkthrough clicked'
        });
    }

    function issueButtonClicked() {
        gtag('event', 'mytime-help-report-issue', {
            'event_category' : 'mytime',
            'event_label' : 'Timesheet Help - Report issue or missing feature clicked'
        }); 
    }
    ...
    function showLikePopup() {
        ...
        gtag('event', 'mytime-help-show-like-popup', {
            'event_category' : 'mytime',
            'event_label' : 'Timesheet Help - Do you like My Time clicked'
        });
    }
